      ...
      new Sortable(targetAreaRef.current, {
        ...
        onAdd: () => {
          ...
          if (currentNumbers.length === numbersCount) {
            ...
            const isCorrect =
              JSON.stringify(currentNumbers) === JSON.stringify(correctOrder);

            if (isCorrect) {
              const newScore =
                gameState.score +
                100 * gameState.currentLevel -
      ...
      <div className="game-content">
        ...
        <div className="progress-container">
          <div
            ...
            style={{
              width: `${(gameState.currentLevel / levelRanges.length) * 100}%`,
            }}
          />
        </div>
          ...
          <div className="game-play-area">
            ...
            <div className="numbers-source">
              <div className="numbers-container" ref={numbersContainerRef}>
                {numbers.map((number) => (
                  <div key={number} className="number-box" data-value={number}>
                    {number}
                  </div>
                ))}
              </div>
